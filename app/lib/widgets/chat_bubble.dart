                ...
                child: message.isLoading
                    ...
                    : MarkdownBody(
                        ...
                        styleSheet: MarkdownStyleSheet(
                          ...
                          h2: const TextStyle(color: AppTheme.textDark, fontWeight: FontWeight.w700, fontSize: 16),
                          h3: const TextStyle(color: AppTheme.textDark, fontWeight: FontWeight.w600, fontSize: 15),
                        ),
                      ),
              ),
